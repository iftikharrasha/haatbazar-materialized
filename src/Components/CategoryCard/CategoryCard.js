                        ...
                        <Col sm={4}>
                                    <a href="#">
                                        <div className="category-card mt-250 bg-tag-5">
                                            ...
                                            <img className="img-fluid pt-4" src={foods} alt=""/>
                                        </div>
                                    </a>
                                    <a href="#">
                                        <div className="category-card mt-30 bg-tag-3">
                                            ...
                                            <img className="img-fluid pt-4" src={clothings} alt=""/>
                                        </div>
                                    </a>
                        </Col>
                        <Col sm={4}>
                                    <a href="#">
                                        <div className="category-card bg-tag-2">
                                            ...
                                            <img className="img-fluid pt-4" src={cosmetics} alt=""/>
                                        </div>
                                    </a>
                                    <a href="#">
                                        <div className="category-card bg-tag-4">
                                            ...
                                            <img className="img-fluid pt-4" src={gadgets} alt=""/>
                                        </div>
                                    </a>
                        </Col>
                        <Col sm={4}>
                                    <a href="#">
                                        <div className="category-card mt-150 bg-tag-1">
                                            ...
                                            <img className="img-fluid pt-4" src={gifts} alt=""/>
                                        </div>
                                    </a>
                                    <a href="#">
                                        <div className="category-card mt-30 bg-tag-5">
                                            ...
                                            <img className="img-fluid pt-4" src={grocery} alt=""/>
                                        </div>
                                    </a>
                        </Col>
                    </Row>
